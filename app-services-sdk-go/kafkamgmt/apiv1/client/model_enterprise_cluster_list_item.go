...
// checks if the EnterpriseClusterListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnterpriseClusterListItem{}
...
func (o EnterpriseClusterListItem) ToMap() (map[string]interface{}, error) {
