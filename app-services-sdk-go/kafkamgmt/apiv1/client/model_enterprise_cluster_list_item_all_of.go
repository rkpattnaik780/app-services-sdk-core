...
// checks if the EnterpriseClusterListItemAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnterpriseClusterListItemAllOf{}
...
func (o EnterpriseClusterListItemAllOf) ToMap() (map[string]interface{}, error) {
