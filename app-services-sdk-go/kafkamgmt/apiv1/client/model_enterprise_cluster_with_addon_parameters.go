...
// checks if the EnterpriseClusterWithAddonParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnterpriseClusterWithAddonParameters{}
...
func (o EnterpriseClusterWithAddonParameters) ToMap() (map[string]interface{}, error) {
