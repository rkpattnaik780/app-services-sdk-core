...
func (m *WithGroupItemRequestBuilder) Artifacts()(*ItemArtifactsRequestBuilder) {
    return NewItemArtifactsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// ArtifactsById manage a single artifact.
func (m *WithGroupItemRequestBuilder) ArtifactsById(id string)(*ItemArtifactsWithArtifactItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    if id != "" {
        urlTplParams["artifactId"] = id
    }
    return NewItemArtifactsWithArtifactItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func NewWithGroupItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WithGroupItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/groups/{groupId}";
    urlTplParams := make(map[string]string)
...
func (m *WithGroupItemRequestBuilder) Get(ctx context.Context, requestConfiguration *WithGroupItemRequestBuilderGetRequestConfiguration)(i061057543182c83985ba910ffdfb7dc0d3545e4ecde182f67803d779bc358586.GroupMetaDataable, error) {
