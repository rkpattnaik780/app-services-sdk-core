...
type DefaultApi interface {
	...
	*/
	...
	/*
	GetSmoketestByName Method for GetSmoketestByName

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param checkName
	@return ApiGetSmoketestByNameRequest
	*/
	GetSmoketestByName(ctx context.Context, checkName string) ApiGetSmoketestByNameRequest

	// GetSmoketestByNameExecute executes the request
	//  @return SSOHealthResult
	GetSmoketestByNameExecute(r ApiGetSmoketestByNameRequest) (*SSOHealthResult, *http.Response, error)
...
type ApiGetSmoketestByNameRequest struct {
	ctx context.Context
	ApiService DefaultApi
	checkName string
}

func (r ApiGetSmoketestByNameRequest) Execute() (*SSOHealthResult, *http.Response, error) {
	return r.ApiService.GetSmoketestByNameExecute(r)
}
...
GetSmoketestByName Method for GetSmoketestByName
 ...
 @return ApiGetSmoketestByNameRequest
*/
func (a *DefaultApiService) GetSmoketestByName(ctx context.Context, checkName string) ApiGetSmoketestByNameRequest {
	return ApiGetSmoketestByNameRequest{
		ApiService: a,
		ctx: ctx,
		checkName: checkName,
...
// Execute executes the request
//  @return SSOHealthResult
func (a *DefaultApiService) GetSmoketestByNameExecute(r ApiGetSmoketestByNameRequest) (*SSOHealthResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SSOHealthResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetSmoketestByName")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/apis/smoketest/v1/smoketests/{checkName}"
	localVarPath = strings.Replace(localVarPath, "{"+"checkName"+"}", url.PathEscape(parameterToString(r.checkName, "")), -1)
