...
def lazy_import():
    ...
    globals()['SearchedGroup'] = SearchedGroup


class GroupSearchResults(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'groups': ([SearchedGroup],),  # noqa: E501
            'count': (int,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, groups, count, *args, **kwargs):  # noqa: E501
        """GroupSearchResults - a model defined in OpenAPI

        Args:
            groups ([SearchedGroup]): The groups returned in the result set.
    ...
    @convert_js_args_to_python_args
    def __init__(self, groups, count, *args, **kwargs):  # noqa: E501
        """GroupSearchResults - a model defined in OpenAPI
