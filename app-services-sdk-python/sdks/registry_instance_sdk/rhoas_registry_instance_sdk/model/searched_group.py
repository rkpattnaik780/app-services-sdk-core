...
class SearchedGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, description, created_on, created_by, modified_on, modified_by, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, description, created_on, created_by, modified_on, modified_by, *args, **kwargs):  # noqa: E501
        """SearchedGroup - a model defined in OpenAPI
