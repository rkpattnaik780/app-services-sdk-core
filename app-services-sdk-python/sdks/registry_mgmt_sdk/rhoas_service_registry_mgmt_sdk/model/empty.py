...
class Empty(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Represents an empty response. if omitted defaults to "", must be one of ["", ]  # noqa: E501

        Keyword Args:
            value (str): Represents an empty response. if omitted defaults to "", must be one of ["", ]  # noqa: E501
