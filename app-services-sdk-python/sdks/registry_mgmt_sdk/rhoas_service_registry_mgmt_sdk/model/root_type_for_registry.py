...
class RootTypeForRegistry(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, name, owner, created_at, updated_at, instance_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, name, owner, created_at, updated_at, instance_type, *args, **kwargs):  # noqa: E501
        """RootTypeForRegistry - a model defined in OpenAPI
