...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AcsTenantsApi()
        api_instance.create_acs_client  # this is an instance of the class Endpoint
        api_instance.create_acs_client()  # this invokes api_instance.create_acs_client.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_acs_client.callable or self.callable in this class
